...
class Recruit(models.Model):
    ...
    relocation_plan = models.CharField(max_length=100, blank=True, null=True, verbose_name='引越し予定')
    ...
    medical_details = models.TextField(blank=True, null=True, verbose_name='持病詳細')
    ...
    vision_1 = models.CharField(max_length=100, blank=True, null=True, verbose_name='ビジョン1')
    vision_2 = models.CharField(max_length=100, blank=True, null=True, verbose_name='ビジョン2')
    vision_3 = models.CharField(max_length=100, blank=True, null=True, verbose_name='ビジョン3')
